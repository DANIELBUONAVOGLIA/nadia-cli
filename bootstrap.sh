...
if [[ "$OS" == "ubuntu" ]]; then
  if [[ "$EUID" -ne 0 ]]; then
    ...
    echo "Tenta: sudo bash <(curl -fsSL https://raw.githubusercontent.com/student2013-bot/agente-claude-telegram-setup-alunos-student/main/bootstrap.sh)"
    exit 1
  fi
  ...
  curl -fsSL https://raw.githubusercontent.com/student2013-bot/agente-claude-telegram-setup-alunos-student/main/SETUP-AGENTE.md \
    -o /root/SETUP-AGENTE.md
  curl -fsSL https://raw.githubusercontent.com/student2013-bot/agente-claude-telegram-setup-alunos-student/main/.env.example \
    -o /root/.env.example
